const caseStudies = [
    {
        ...
        industry: ["Логистика"],
        metrics: ["MQL", "Brand Recall", "SQL", "Win Rate", "Sales Cycle", "Average Deal Size", "NPS", "Customer Retention Rate"],
        result: "75% - 100%",
        complexity: "Средняя",
    ...
    },
    {
        ...
        metrics: ["CPM", "CTR", "CPL", "LTV", "NPS", "Brand Recall", "Impressions", "Website Visitors", "Revenue Growth"],
        result: "75% - 100%",
        complexity: "Средняя",
    ...
    },
    {
        ...
        company: "P7-Офис",
        industry: ["IT"],
        metrics: ["Search Lift", "Visit Lift", "Target Lift Reach", "Website Visitors", "MQL", "SQL", "Lead-to-Customer Rate", "ROI/ROMI"],
        result: "75% - 100%",
        complexity: "Сложная",
    ...
    },
    {
        ...
        company: "ЛогистПро",
        industry: ["Логистика"],
        metrics: ["Reach", "CTR", "CPL", "Frequency", "Video Views", "Time to Response", "Cost Reduction", "Process Automation Level"],
        result: "50% - 75%",
        complexity: "Средняя",
